...
A similar pattern is observed in the interactions between the protein and both DNA and RNA, reinforcing the notion that S4b represents a transitional state (Figure SX5A) towards the fully activated I4 conformation (Figure 5). This suggests that similar to the BH-H1/lid contacts, protein and nucleic acid interactions also become progressively stronger and more frequent as the system advances towards the activation pathway.

<img width="454" height="189" alt="image" src="https://github.com/user-attachments/assets/6f6ce2af-e510-45a7-9692-1e0e24898674" />

Figure 5. Probability density distribution obtained during MD simulations of the distances between (A) Cas12aKD2P S4b state interactions R964 NH2 and -dT8 O3’ DNA (purple), R964 NH1 and -dT7 OP1 DNA (green), and R968 NE and U10 O3’ RNA (blue) and (B) Cas12aWT I4 state interactions R964 NH2 and -dT8 O3’ DNA (purple), R964 NH1 and -dT7 OP1 DNA (green), and R968 NE and U10 O3’ RNA (blue). The interactions with crRNA/DNA are formed in the pre-catalytic state.
